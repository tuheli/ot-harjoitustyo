...
class TestMaksukortti(unittest.TestCase):
    ...
    def test_syo_maukkaasti_ei_vie_saldoa_negatiiviseksi(self):
        ...
        self.assertEqual(kortti.saldo_euroina(), 0.1)        
    ...
    def test_negatiivinen_lataus_ei_muuta_saldoa(self):
        self.kortti.lataa_rahaa(-1234)

        self.assertEqual(self.kortti.saldo_euroina(), 10.0)

    def test_edullisen_lounaan_voi_ostaa_kun_saldo_on_tasan_sen_hinnan(self):
        kortti = Maksukortti(250)
        kortti.syo_edullisesti()

        self.assertEqual(kortti.saldo_euroina(), 0.0)

    def test_maukkaan_lounaan_voi_ostaa_kun_saldo_on_tasan_sen_hinnan(self):
